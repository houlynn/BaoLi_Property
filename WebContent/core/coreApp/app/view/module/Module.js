 ...
 */
Ext.define('core.app.view.module.Module', {
			extend : 'Ext.panel.Panel',

			alias : 'widget.modulepanel',

			requires : ['core.app.view.module.ModuleController',
					'core.app.view.module.ModuleModel', 'core.app.view.module.factory.ModelFactory'],

			uses : ['core.app.view.module.region.Navigate', 'core.app.view.module.region.Grid',
					'core.app.view.module.region.Detail', 'core.app.view.module.window.BaseWindow'],
