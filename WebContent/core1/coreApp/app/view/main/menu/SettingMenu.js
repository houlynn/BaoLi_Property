 ...
 */
Ext.define('core.app.view.main.menu.SettingMenu', {
			extend : 'core.app.ux.ButtonTransparent',
			alias : 'widget.settingmenu',
			uses : ['core.app.view.main.menu.Monetary'],
			text : '设置',
			glyph : 0xf013,
			tooltip : '偏好设置',
				...
				this.menu.push({
							...
							menu : [{
										...
										menu : [{
													...
													defaultUI : 'default',
													value : 'tenthousand',
													items : core.app.view.main.menu.Monetary.getMonetaryMenu()
												}]
									}, {
										text : '金额单位位置',
										menu : [{
