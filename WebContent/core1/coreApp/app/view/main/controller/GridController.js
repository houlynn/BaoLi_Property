 ...
 * 
 */
Ext.define('core.app.view.main.controller.GridController', {
			extend : 'Ext.Mixin',
			...
			onMonetaryChange : function(value) {
				...
				if (this.getView().down('settingmenu').getMenu().isVisible())
					Ext.toastInfo('信息', '列表金额单位：'
									+ core.app.view.main.menu.Monetary.getMonetary(value).unitText, {
								align : 'tl'
							});

				var m = core.app.view.main.menu.Monetary.getMonetary(value);
				Ext.monetary = m;
				Ext.monetaryText = Ext.monetaryPosition === 'behindnumber'
						? Ext.monetary.monetaryText
						: ''; // 设置当前的全局的金额单位
